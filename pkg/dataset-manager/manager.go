...
import (
	...
	"github.com/hwameistor/hwameistor/pkg/dataset-manager/datasource"
...
type datasetController struct {
	dsController datasource.DSController
...
func New(kubeClientset *kubernetes.Clientset, dsClientset *dsclientset.Clientset, hmClientset *hmclientset.Clientset,
	dsInformer dsinformers.DataSourceInformer, pvInformer v12.PersistentVolumeInformer) DatasetController {
	return &datasetController{
		dsController: datasource.New(kubeClientset, dsClientset, hmClientset, dsInformer),
