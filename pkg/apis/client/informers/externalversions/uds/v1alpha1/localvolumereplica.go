	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UdsV1alpha1().LocalVolumeReplicas().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UdsV1alpha1().LocalVolumeReplicas().Watch(context.TODO(), options)
			},
		},
		&udsv1alpha1.LocalVolumeReplica{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *localVolumeReplicaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&udsv1alpha1.LocalVolumeReplica{}, f.defaultInformer)
}
