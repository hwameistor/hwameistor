...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.29.6 // Required by prometheus-operator
...
replace sigs.k8s.io/controller-runtime => sigs.k8s.io/controller-runtime v0.17.5
