...
func TestDevice_ParseDeviceInfo(t *testing.T) {
	testCases := []struct {
		...
		{
			Description: "It is an udevadm info result for virtio device",
			UdevInfo:    "P: /devices/pci0000:00/0000:00:07.0/virtio4/block/vda\nM: vda\nU: block\nT: disk\nD: b 253:0\nN: vda\nL: 0\nS: disk/by-diskseq/9\nS: disk/by-path/virtio-pci-0000:00:07.0\nS: disk/by-path/pci-0000:00:07.0\nQ: 9\nE: DEVPATH=/devices/pci0000:00/0000:00:07.0/virtio4/block/vda\nE: DEVNAME=/dev/vda\nE: DEVTYPE=disk\nE: DISKSEQ=9\nE: MAJOR=253\nE: MINOR=0\nE: SUBSYSTEM=block\nE: USEC_INITIALIZED=2424881\nE: ID_PATH=pci-0000:00:07.0\nE: ID_PATH_TAG=pci-0000_00_07_0\nE: ID_PART_TABLE_UUID=fd52410a\nE: ID_PART_TABLE_TYPE=dos\nE: DEVLINKS=/dev/disk/by-diskseq/9 /dev/disk/by-path/virtio-pci-0000:00:07.0 /dev/disk/by-path/pci-0000:00:07.0\nE: TAGS=:systemd:\nE: CURRENT_TAGS=:systemd:\n",
			ExpectDevice: &Device{
		...
		{
			Description: "It is an udevadm info result for virtio device (LVM)",
			UdevInfo:    "P: /devices/pci0000:00/0000:00:0a.0/virtio7/block/vdb\nM: vdb\nU: block\nT: disk\nD: b 253:16\nN: vdb\nL: 0\nS: disk/by-id/lvm-pv-uuid-j0SJMZ-AdTs-wE89-CDCC-zx0T-qXaL-18ZkFA\nS: disk/by-path/pci-0000:00:0a.0\nS: disk/by-path/virtio-pci-0000:00:0a.0\nS: disk/by-diskseq/10\nQ: 10\nE: DEVPATH=/devices/pci0000:00/0000:00:0a.0/virtio7/block/vdb\nE: DEVNAME=/dev/vdb\nE: DEVTYPE=disk\nE: DISKSEQ=10\nE: MAJOR=253\nE: MINOR=16\nE: SUBSYSTEM=block\nE: USEC_INITIALIZED=2428146\nE: ID_PATH=pci-0000:00:0a.0\nE: ID_PATH_TAG=pci-0000_00_0a_0\nE: ID_FS_UUID=j0SJMZ-AdTs-wE89-CDCC-zx0T-qXaL-18ZkFA\nE: ID_FS_UUID_ENC=j0SJMZ-AdTs-wE89-CDCC-zx0T-qXaL-18ZkFA\nE: ID_FS_VERSION=LVM2 001\nE: ID_FS_TYPE=LVM2_member\nE: ID_FS_USAGE=raid\nE: DEVLINKS=/dev/disk/by-id/lvm-pv-uuid-j0SJMZ-AdTs-wE89-CDCC-zx0T-qXaL-18ZkFA /dev/disk/by-path/pci-0000:00:0a.0 /dev/disk/by-path/virtio-pci-0000:00:0a.0 /dev/disk/by-diskseq/10\nE: TAGS=:systemd:\nE: CURRENT_TAGS=:systemd:\n",
			ExpectDevice: &Device{
				DevPath:       "/devices/pci0000:00/0000:00:0a.0/virtio7/block/vdb",
				DevName:       "/dev/vdb",
				DevType:       "disk",
				Major:         "253",
				Minor:         "16",
