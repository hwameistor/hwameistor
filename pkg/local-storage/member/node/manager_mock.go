...
// Source: local_storage_member.go
...
func (m *MockLocalStorageMember) ConfigureBase(nodeName, hostName, namespace string, haSystemConfig v1alpha1.SystemConfig, cli client.Client, informersCache cache.Cache, recorder record.EventRecorder) apis.LocalStorageMember {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConfigureBase", nodeName, hostName, namespace, haSystemConfig, cli, informersCache, recorder)
	ret0, _ := ret[0].(apis.LocalStorageMember)
	return ret0
}

// ConfigureBase indicates an expected call of ConfigureBase.
func (mr *MockLocalStorageMemberMockRecorder) ConfigureBase(nodeName, hostName, namespace, haSystemConfig, cli, informersCache, recorder interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConfigureBase", reflect.TypeOf((*MockLocalStorageMember)(nil).ConfigureBase), nodeName, hostName, namespace, haSystemConfig, cli, informersCache, recorder)
}
