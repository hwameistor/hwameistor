	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.UdsV1alpha1().PhysicalDisks().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.UdsV1alpha1().PhysicalDisks().Watch(context.TODO(), options)
			},
		},
		&udsv1alpha1.PhysicalDisk{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *physicalDiskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&udsv1alpha1.PhysicalDisk{}, f.defaultInformer)
}
