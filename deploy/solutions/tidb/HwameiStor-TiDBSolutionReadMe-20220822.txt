...
[root@k8s-10-6-163-52 ~]# kubectl get no
...
[root@k8s-10-6-163-52 ~]# kubectl get all -n hwameistor
...
[root@k8s-10-6-163-52 ~]# kubectl get ld
...
[root@k8s-10-6-163-52 ~]# kubectl get sc
...
[root@k8s-10-6-163-52 ~]# kubectl get crd | grep pingcap
...
[root@k8s-10-6-163-52 ~]# kubectl get po -n tidb-cluster
NAME                               READY   STATUS    RESTARTS   AGE
...
[root@k8s-10-6-163-52 ~]# kubectl get pvc -n tidb-cluster
...
3.4 Connect TiDB Cluster

kubectl get svc -n tidb-cluster

[root@k8s-10-6-163-52 ~]# kubectl get svc -n tidb-cluster
NAME              TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)               AGE
...
[root@k8s-10-6-163-52 ~]# mysql -h 127.0.0.1 -P 4000 -u root
...
MySQL [(none)]> packet_write_wait: Connection to 10.6.163.52 port 22: Broken pipe
