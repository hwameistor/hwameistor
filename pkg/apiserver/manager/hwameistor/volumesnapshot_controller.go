...
func (vsController *VolumeSnapshotController) AddVolumeSnapshot(name, volumesnapshotClassName, pvcName string) error {
...
func (vsController *VolumeSnapshotController) DeleteVolumeSnapshot(name string) error {
...
func (vsController *VolumeSnapshotController) RestoreVolumeSnapshot(name, pvcName, storage string) error {
	if pvcName == "" || storage == "" {
...
func (vsController *VolumeSnapshotController) RollbackVolumeSnapshot(vsname string) error {
